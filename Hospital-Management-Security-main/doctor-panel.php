...
// 3. DATABASE CONNECTION (Secure & Robust)
mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT);

try {
    include('func1.php');
    // Note: Using standard local connection settings. 
...
// 4. CANCEL APPOINTMENT LOGIC (Secure Prepared Statement with IDOR Prevention)
if(isset($_GET['cancel'])) {
    try {
        $id = $_GET['ID'];
        // Secure query PREVENTS IDOR: Only allows canceling appointments assigned to current doctor
        ...
        if($stmt->affected_rows > 0) {
            ...
            echo "<script>alert('Error: Appointment not found or unauthorized access.');</script>";
        }
    ...
    <div class="row">
      <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
        <div class="list-group" id="list-tab" role="tablist">
          ...
          <a class="list-group-item list-group-item-action" href="#list-app" id="list-app-list" role="tab" data-toggle="list">Appointments</a>
          <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list">Prescription List</a>
        </div><br>
      </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if(($row['userStatus']==1) && ($row['doctorStatus']==1)) { ?>
                          <a href="doctor-panel.php?ID=<?php echo $row['ID']?>&cancel=update" 
                              ...
                              title="Cancel Appointment"><button class="btn btn-danger">Cancel</button></a>
                      ...
                      <td>
                        <?php if(($row['userStatus']==1) && ($row['doctorStatus']==1)) { ?>
                          ...
                          title="prescribe"><button class="btn btn-success">Prescribe</button></a>
                        <?php } else { echo "-"; } ?>
                      </td>
                    </tr>
                  <?php } 
